(function () {
  ...
  function guestPage() {
    ...
    page('访客网络',
      ...
      bandFields('2g','2.4GHz')+
      bandFields('5g','5GHz')+
      bandFields('52g','5.8GHz')+'</div>'+
