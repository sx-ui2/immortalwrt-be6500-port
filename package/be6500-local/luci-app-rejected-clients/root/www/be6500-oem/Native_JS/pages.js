(function () {
  ...
  function rpc(method, args) {
    return fetch(API, {
      ...
      if (response.status === 403 && response.headers.get('x-luci-login-required')) {
        ...
        throw new Error('登录会话已过期，正在重新进入登录页面');
      }
  ...
  function wifiPage() {
    ...
    function load() {
      fetch(endpoint,{credentials:'same-origin',cache:'no-store'}).then(function(r){if(!r.ok)throw new Error('HTTP '+r.status);return r.json();}).then(function(data){
  ...
  style.textContent = '\
    *{box-sizing:border-box}html,body{min-height:100%;margin:0!important;background:#fff!important;color:#333!important;font-family:"PingFang SC","Microsoft YaHei",Arial,sans-serif;font-size:14px}\
    ...
    .native-toggle{display:inline-flex!important;align-items:center;gap:12px;min-height:46px;cursor:pointer;font-weight:400!important}.native-toggle input{position:absolute;opacity:0;pointer-events:none}.native-toggle span{display:inline-block;width:46px;height:24px;border-radius:13px;background:#d8dbe2;position:relative;transition:.18s}.native-toggle span:after{content:"";position:absolute;width:20px;height:20px;left:2px;top:2px;border-radius:50%;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.18);transition:.18s}.native-toggle input:checked+span{background:#4762fe}.native-toggle input:checked+span:after{left:24px}.native-toggle b{color:#666;font-weight:400}.native-password{display:flex;position:relative}.native-password input{padding-right:48px!important}.native-password button{position:absolute;right:0;top:0;width:46px;height:46px;border:0;background:transparent;border-radius:0;cursor:pointer}.native-password button img{width:20px;height:20px;object-fit:contain;opacity:.72}\
  ...
  oemStyle.textContent = '\
    ...
    .native-toggle{display:inline-flex!important;align-items:center!important;min-height:46px!important;gap:10px!important;cursor:pointer!important}.native-toggle input{position:absolute!important;opacity:0!important;pointer-events:none!important}.native-toggle img{display:block;width:46px;height:26px;object-fit:contain}.native-toggle b{color:#666!important;font-size:14px!important;font-weight:400!important}.native-inline-choice{width:33.33333333%;margin:-9px 0 14px 16.66666667%;padding-left:20px}.native-inline-choice .native-toggle{min-height:26px!important}.native-inline-choice .native-toggle img{width:16px;height:16px;content:url("../../P_IMG/no-choice.png")}.native-inline-choice .native-toggle input:checked+img{content:url("../../P_IMG/choice.png")}\
    ...
    @media(max-width:760px){.native-router{margin:24px!important}.native-management,.native-advanced{padding:28px 24px!important}.native-row{display:block!important}.native-row>div:first-child,.native-row>.native-control{width:100%!important;max-width:none!important;flex:none!important}.native-actions{width:100%!important;margin-left:0!important}.native-inline-choice{width:100%;margin-left:0}.native-status,.native-warning{width:100%;margin-left:0!important}.native-device-tools{position:static;justify-content:flex-end;margin-top:-48px}.native-table{overflow-x:auto}.native-table ul{min-width:760px}.native-modal{top:10px;width:calc(100% - 20px);padding:24px}.native-modal .native-row>div:first-child{max-width:none!important}.native-modal .native-actions{width:100%!important}}';
