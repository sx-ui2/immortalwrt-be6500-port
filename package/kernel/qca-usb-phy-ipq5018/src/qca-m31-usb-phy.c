 ...
 *
 * This is the legacy usb_phy implementation used by the factory IPQ5332
 * QSDK device tree.  Keeping this binding is intentional: the newer generic
 * PHY driver requires a different clock/regulator description and must not
 * claim the factory qca,ipq5332-m31-usb-hsphy node.
 */
...
static const struct of_device_id m31usb_phy_id_table[] = {
	/* QSDK factory trees use the qca prefix.  The public Qualcomm binding
	 * uses qcom, so accept both spellings without changing factory DTBs.
	 */
...
MODULE_DESCRIPTION("QTI factory-compatible M31 USB2 PHY driver");
